...
using USCSandbox.ShaderCode.Converters.DirectXDisassembler.Blocks;
...
public class DirectXProgramToUsil
{
    ...
    private void ConvertInstructions()
    {
        ...
        for (int i = 0; i < instructions.Count; i++)
        {
            ...
            {
                int ignore = 0;
                string disasm = DirectXDisassemblyHelper.DisassembleInstruction(inst, ref ignore);
    ...
    private void ConvertInputs()
    {
        ...
        for (int i = 0; i < dxInputs.Length; i++)
        {
            ...
            string inputFormat = HlslNamingUtils.GetISGNFormatName(dxInput);
            string inputType = dxInput.name + (dxInput.index > 0 ? dxInput.index : "");
            string inputName = HlslNamingUtils.GetISGNInputName(dxInput);
    ...
    private void ConvertOutputs()
    {
        ...
        for (int i = 0; i < dxOutputs.Length; i++)
        {
            ...
            string outputFormat = HlslNamingUtils.GetOSGNFormatName(dxOutput);
            string outputType = dxOutput.name + (dxOutput.index > 0 ? dxOutput.index : "");
            string outputName = HlslNamingUtils.GetOSGNOutputName(dxOutput);
    ...
    private void HandleXor(SHDRInstruction inst)
    {
        ...
        usilInst.InstructionType = UsilInstructionType.Xor;
        usilInst.DestOperand = usilDest;
        usilInst.SrcOperands = new List<UsilOperand>
        {
            usilSrc0,
    ...
    private void HandleExp(SHDRInstruction inst)
    {
        ...
        UsilInstruction usilInst = new UsilInstruction();
        UsilOperand usilDest = new UsilOperand();
        UsilOperand usilSrc0 = new UsilOperand(2f);
        UsilOperand usilSrc1 = new UsilOperand();
    ...
    private void HandleSwitch(SHDRInstruction inst)
    {
        ...
        usilInst.InstructionType = UsilInstructionType.Switch;
        usilInst.DestOperand = null;
        usilInst.SrcOperands = new List<UsilOperand>
        {
            usilSrc0
    ...
    private void HandleCase(SHDRInstruction inst)
    {
        SHDRInstructionOperand src0 = inst.operands[0];
        ...
        FillUSILOperand(src0, usilSrc0, src0.swizzle, true);

        usilInst.InstructionType = UsilInstructionType.Case;
        usilInst.DestOperand = null;
        usilInst.SrcOperands = new List<UsilOperand>
        {
            usilSrc0
    ...
    private void HandleDefault(SHDRInstruction inst)
    {
        UsilInstruction usilInst = new UsilInstruction();

        usilInst.InstructionType = UsilInstructionType.Default;
        usilInst.DestOperand = null;
        usilInst.SrcOperands = new List<UsilOperand>
        {
        };
    ...
    private void HandleEndSwitch(SHDRInstruction inst)
    {
        UsilInstruction usilInst = new UsilInstruction();

        usilInst.InstructionType = UsilInstructionType.EndSwitch;
        usilInst.DestOperand = null;
        usilInst.SrcOperands = new List<UsilOperand>
        {
        };
