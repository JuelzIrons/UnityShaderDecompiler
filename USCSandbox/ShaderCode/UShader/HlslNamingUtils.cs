...
public static class HlslNamingUtils
{
    public static string GetConstantBufferParamTypeName(ConstantBufferParameter param)
        => GetConstantBufferParamTypeName(param.Rows, param.Columns, param.ParamType, true);
